...
const page = () => {
  ...
  const blogId = searchParams.get("id"); // edit mode if exists
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      const response = blogId
        ? await axios.put(`/api/blog?id=${blogId}`, formData) // EDIT
        : await axios.post("/api/blog", formData); // ADD

      if (response.data.success) {
        toast.success(response.data.msg);

        // ✅ redirect AFTER add/edit blog
